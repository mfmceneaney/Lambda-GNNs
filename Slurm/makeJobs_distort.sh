...
runJobs="${working_folder}/runDistort.sh"
...
#SBATCH --mem=32G
#SBATCH --output=${output_folder}/${extra_info}output_${value_string}.txt
#SBATCH --error=${error_folder}/${extra_info}error_${value_string}.txt
