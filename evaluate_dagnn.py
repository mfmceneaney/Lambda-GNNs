...
def main():
    ...
    # Train model
    evaluate(model, device, dataset=args.dataset, prefix=args.prefix, split=args.split, log_dir=args.log, verbose=args.verbose, batch_size=args.batch, num_workers=args.nworkers)
