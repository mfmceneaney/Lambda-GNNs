...
def main():
    ...
    # print("DEBUGGING: nclasses, nfeatures = ",nclasses,nfeatures)#DEBUGGING
    ...
    # Train model
    evaluate(model, device, dataset=args.dataset, prefix=args.prefix, eval_loader=eval_loader, split=args.split, log_dir=args.log, verbose=args.verbose)
