...
def evaluate(model, device, test_dataloader,dataset="ldata_6_22",verbose=True):
    ...
    if verbose: plt.show()
    f.savefig(model.name+"_ROC_"+datetime.datetime.now().strftime("%F")+dataset_name+"_nEps"+str(num_epochs)+".png")
